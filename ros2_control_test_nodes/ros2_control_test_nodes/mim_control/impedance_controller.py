##################################################################################################################
## This is the implementation for mim_control_ controller between any two frames of the robot.
...
class ImpedanceController(object):
    def __init__(
        ...
        """
        Input :
            name : Name of the mim_control_ controller (Ex. Front left leg mim_control_)
    ...
    def compute_distance_between_frames(self, q=None):
        """
    ...
    def compute_impedance_torques_world(self, q, dq, kp, kd, x_des, xd_des, f):
        """Computes the leg mim_control_ using world coordinate x_des and xd_des.
